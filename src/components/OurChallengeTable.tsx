...
export default function OurChallengeTable() {
  return (
    <div className="flex items-center justify-center w-full">
      ...
      <div
        className=" p-[1px]  rounded-[25px] w-full border-tb-g "
      >
            ...
            <div className="bg-primary-bg-color text-white rounded-[25px] text-center p-2 md:p-10 w-full divide-y divide-primary/60 space-y-5">
              <div className="flex items-center justify-center ">
                <div className="grid gap-4  md:grid-cols-5 md:py-[10px] px-2  md:p-[10px] max-w-[814px] w-full  rounded-full  ">
                  <button
                    type="submit"
                    className="flex justify-center items-center gap-2 rounded-full px-3 py-2 lg:px-8 lg:py-3 font-medium  w-full sm:py-2  text-black bg-primary "
                  >
                    $10,000
                  </button>
                  <button
                    type="submit"
                    className="flex justify-center items-center gap-2 rounded-full lg:px-8 lg:py-3 font-medium  w-full px-1 py-1 sm:py-2   text-white bg-white/10 "
                  >
                    $25,000
                  </button>
                  <button
                  ...
                  <button
                    type="submit"
                    className="flex justify-center items-center gap-2 rounded-full lg:px-8 lg:py-3 font-medium   w-full px-1 py-1 sm:py-2 bg bg-white/10 text-white "
                  >
                    $100,000
                  </button>
                  <button
